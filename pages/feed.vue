    ...
    <div class="container mx-auto pb-7 ">
        <ul class="flex flex-col items-center justify-start" v-auto-animate>
            ...
            <li class="w-[32rem] h-8 group sticky top-0 z-[99999]"  >
                ...
                <div v-if="y<250" @click="reloadPosts" class="bg-stone-950 border-b border-stone-800 group-hover:bg-stone-700 w-full h-8  cursor-pointer flex items-center justify-center">
                    <Icon name="basil:history-outline" size="2rem"/>
                </div>
            </li>
